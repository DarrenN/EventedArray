...
(function() {
  define(['eventedarray', 'underscore'], function(EventedArray, _) {
    var enumerable;
    enumerable = new EventedArray();
    return describe('EventedArray', function() {
      ...
      return describe('EventedArray Events', function() {
        var catchFn;
